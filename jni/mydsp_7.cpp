...
class mydsp : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* interface) {
		...
		interface->addHorizontalBargraph("0x2b75dc0", &fbargraph0, -7e+01f, 5.0f);
		interface->addHorizontalSlider("gain", &fslider0, 0.5f, 0.0f, 1.0f, 0.01f);
		interface->closeBox();
	}
